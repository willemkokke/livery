...
#
# Read from claude 2.1.238 on Linux, Windows and macOS. In-process: no.
            ...
            def __call__(  # type: ignore[override]
                ...
                **flags: Any,
                ...
                Args:
                    ...
                    yes: Accept the displayed marketplace-declared command without the confirmation prompt - a plugin installed by running a command, or one whose archive is fetched through a headersHelper command (required when stdin or stdout is not a TTY). Added in 2.1.229.
                """
                ...
            @property
            ...
            def __call__(  # type: ignore[override]
                ...
                **flags: Any,
                ...
                Args:
                    ...
                    yes: Accept the displayed marketplace-declared command without the confirmation prompt - a changed install command, or the headersHelper command that fetches its archive (required when stdin or stdout is not a TTY). Added in 2.1.229.
                """
                ...
            @property
