...
#
# Read from bun 1.4.0 on Linux, Windows and macOS. In-process: no.
        ...
        def __call__(  # type: ignore[override]
            ...
            **flags: Any,
            ...
            Args:
                ...
                catalog: Add the resolved version to the root package.json catalog and depend on it as "catalog:" (use --catalog=NAME for a named catalog). Added in 1.4.0.
                ...
                filter: Add the package(s) to the matching workspaces instead of the current package. Added in 1.4.0.
        ...
        def __call__(  # type: ignore[override]
            ...
            **flags: Any,
            ...
            Args:
                ...
                asset: Embed a file or directory into the compiled executable, preserving its relative path (requires --compile). Added in 1.4.0.
                ...
                react_compiler: Enable the React Compiler optimizing transform. Added in 1.4.0.
        ...
        def __call__(  # type: ignore[override]
            ...
            **flags: Any,
            ...
            Args:
                ...
                cwd: Set a specific cwd.
                dry_run: Perform a dry run without making changes.
                filter: Remove the package(s) from the matching workspaces instead of the current package. Added in 1.4.0.
                force: Always request the latest versions from the registry & reinstall all dependencies.
                frozen_lockfile: Disallow changes to lockfile.
                global_: Install globally.
                ignore_scripts: Skip lifecycle scripts in the project's package.json (dependency scripts are never run).
        ...
        def __call__(  # type: ignore[override]
            ...
            **flags: Any,
            ...
            Args:
                ...
                disable_warning: Silence specific process warnings by code or type. Added in 1.4.0.
                ...
                experimental_stream_iter: Enable the experimental stream/iter API (node:stream/iter, node:zlib/iter). Added in 1.4.0.
                ...
                heap_prof: Write a heap profile to disk on exit (.heapprofile). Added in 1.3.7.
                heap_prof_dir: Specify the directory where the heap profile will be saved. Added in 1.3.7.
                heap_prof_interval: Specify the average sampling interval in bytes for heap profiling. Defaults to `524288`. Added in 1.4.0.
                ...
                insecure_http_parser: Use an insecure HTTP parser that accepts invalid HTTP headers. Added in 1.4.0.
                ...
                interactive: Start a Node.js-compatible REPL, like node --interactive. Added in 1.4.0.
                ...
                no_orphans: Exit when the parent process dies, and on exit kill every descendant. Added in 1.3.14.
                no_warnings: Silence all process warnings. Added in 1.4.0.
                parallel: Run multiple scripts concurrently with Foreman-style output. Added in 1.3.9.
                pending_deprecation: Emit pending deprecation warnings. Added in 1.4.0.
                ...
                redirect_warnings: Write process warnings to the given file instead of printing to stderr. Added in 1.4.0.
                ...
                tls_max_v1_2: Set the default TLS maximum to TLSv1.2. Added in 1.4.0.
                tls_max_v1_3: Set the default TLS maximum to TLSv1.3. Added in 1.4.0.
                tls_min_v1_0: Set the default TLS minimum to TLSv1.0. Added in 1.4.0.
                tls_min_v1_1: Set the default TLS minimum to TLSv1.1. Added in 1.4.0.
                tls_min_v1_2: Set the default TLS minimum to TLSv1.2. Added in 1.4.0.
                tls_min_v1_3: Set the default TLS minimum to TLSv1.3. Added in 1.4.0.
                trace_deprecation: Show stack traces on deprecations. Added in 1.4.0.
                trace_warnings: Show stack traces on process warnings. Added in 1.4.0.
                ...
                watch: Automatically restart the process on file change.
                watch_kill_signal: Signal whose handlers run when --watch restarts the process. Defaults to `SIGTERM`. Added in 1.4.0.
        ...
        def __call__(  # type: ignore[override]
            ...
            **flags: Any,
            ...
            Args:
                ...
                isolate: Run each test file in a fresh global object. `isolate=off` emits `--no-isolate`. Added in 1.3.13.
                ...
                timings: JSON file(s) of per-file durations (ms); several are merged, e.g. one per CI shard. Added in 1.4.0.
                todo: Include tests that are marked with "test.todo()".
                update_snapshots: Update snapshot files.
                update_timings: After the run, write measured per-file durations to the first --timings file (only this shard's files under --shard; merged with what was read otherwise). Added in 1.4.0.
            """
            ...
        @property
    ...
    def __call__(  # type: ignore[override]
        ...
        **flags: Any,
        ...
        Args:
            ...
            cron_title: Title for cron execution mode. Added in 1.3.11.
            cwd: Absolute path to resolve files & entry points from.
            define: Substitute K:V while parsing, e.g. --define process.env.NODE_ENV:"development". Added in 1.4.0.
            disable_warning: Silence specific process warnings by code or type. Added in 1.4.0.
            dns_result_order: Set the default order of DNS lookup results.
            drop: Remove function calls, e.g. --drop=console removes all console.* calls. Added in 1.4.0.
            elide_lines: Number of lines of script output shown when using --filter . Defaults to `10`.
            env_file: Load environment variables from the specified file(s).
            eval: Evaluate argument as a script.
            experimental_http2_fetch: Offer h2 in fetch() TLS ALPN. Added in 1.3.14.
            ...
            experimental_stream_iter: Enable the experimental stream/iter API (node:stream/iter, node:zlib/iter). Added in 1.4.0.
            expose_gc: Expose gc() on the global object.
            extension_order: Defaults to: .tsx,.ts,.jsx,.js,.json. Added in 1.4.0.
            feature: Enable a feature flag for dead-code elimination, e.g. --feature=SUPER_SECRET. Added in 1.4.0.
            fetch_preconnect: Preconnect to a URL while code is loading.
            filter: Run a script in all workspace packages matching the pattern.
            heap_prof: Write a heap profile to disk on exit (.heapprofile). Added in 1.3.7.
            heap_prof_dir: Specify the directory where the heap profile will be saved. Added in 1.3.7.
            ...
            i: Auto-install dependencies during execution.
            if_present: Exit without an error if the entrypoint does not exist.
            ignore_dce_annotations: Ignore tree-shaking annotations such as @__PURE__. Added in 1.4.0.
            import_: Alias of --preload, for Node.js compatibility.
            insecure_http_parser: Use an insecure HTTP parser that accepts invalid HTTP headers. Added in 1.4.0.
            inspect: Activate Bun's debugger.
            inspect_brk: Activate Bun's debugger, set breakpoint on first line of code and wait.
            ...
            install: Configure auto-install behavior.
            interactive: Start a Node.js-compatible REPL, like node --interactive. Added in 1.4.0.
            jsx_factory: Changes the function called when compiling JSX elements using the classic JSX runtime. Added in 1.4.0.
            jsx_fragment: Changes the function called when compiling JSX fragments. Added in 1.4.0.
            jsx_import_source: Declares the module specifier to be used for importing the jsx and jsxs factory functions. Added in 1.4.0.
            jsx_runtime: "automatic" (default) or "classic". Added in 1.4.0.
            jsx_side_effects: Treat JSX elements as having side effects (disable pure annotations). Added in 1.4.0.
            loader: Parse files with .ext:loader, e.g. --loader .js:jsx. Added in 1.4.0.
            main_fields: Main fields to lookup in package.json. Added in 1.4.0.
            max_http_header_size: Set the maximum size of HTTP headers in bytes.
            no_addons: Throw an error if process.dlopen is called, and disable export condition "node-addons".
            no_clear_screen: Disable clearing the terminal screen on reload when --hot or --watch is enabled.
            no_deprecation: Suppress all reporting of the custom deprecation.
            ...
            no_exit_on_error: Continue running other scripts when one fails (with --parallel/--sequential). Added in 1.3.9.
            no_install: Disable auto install in the Bun runtime.
            no_macros: Disable macros from being executed in the bundler, transpiler and runtime. Added in 1.4.0.
            no_orphans: Exit when the parent process dies, and on exit kill every descendant. Added in 1.3.14.
            no_warnings: Silence all process warnings. Added in 1.4.0.
            parallel: Run multiple scripts concurrently with Foreman-style output. Added in 1.3.9.
            pending_deprecation: Emit pending deprecation warnings. Added in 1.4.0.
            ...
            prefer_offline: Skip staleness checks for packages in the Bun runtime and resolve from disk.
            preload: Import a module before other modules are loaded.
            preserve_symlinks: Preserve symlinks when resolving files. Added in 1.4.0.
            preserve_symlinks_main: Preserve symlinks when resolving the main entry point. Added in 1.4.0.
            print: Evaluate argument as a script and print the result.
            redirect_warnings: Write process warnings to the given file instead of printing to stderr. Added in 1.4.0.
            redis_preconnect: Preconnect to $REDIS_URL at startup.
            require: Alias of --preload, for Node.js compatibility.
            ...
            trace_deprecation: Show stack traces on deprecations. Added in 1.4.0.
            trace_warnings: Show stack traces on process warnings. Added in 1.4.0.
            tsconfig_override: Specify custom tsconfig.json. Added in 1.4.0.
            unhandled_rejections: One of "strict", "throw", "warn", "none", or "warn-with-error-code".
            use_bundled_ca: Use bundled CA store.
            use_openssl_ca: Use OpenSSL's default CA store.
            use_system_ca: Use the system's trusted certificate authorities.
