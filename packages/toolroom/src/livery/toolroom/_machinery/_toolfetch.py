...
from livery.toolroom._machinery._drivers import Driver, Plugin, Provision
...
def _read_index(request: urllib.request.Request, url: str) -> bytes:
    ...
    """
    from livery.toolroom._machinery._provision import _worth_retrying
...
def _index(url: str) -> Any:
    ...
    """
    from livery.toolroom._machinery._provision import api_headers
...
def _forge(driver: Driver, host: str, pages: int = 1) -> list[Release]:
    ...
    """
    from livery.toolroom import read_version
