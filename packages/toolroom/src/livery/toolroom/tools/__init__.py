...
from livery.toolroom.tools._host import Argv as Argv
...
def __getattr__(name: str) -> Tool:
    ...
    if name == "testing":
        # The one attribute that is a module, not a tool. `from livery.toolroom.tools
        ...
        return _cast("Tool", importlib.import_module("livery.toolroom.tools.testing"))
