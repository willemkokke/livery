...
def test_optvalue_stub_type_accepts_bare_and_valued():
    from livery.toolroom._machinery._toolspec import Option
...
def test_rendered_stub_imports_only_what_it_uses():
    ...
    assert "from livery.toolroom import Argv, Flag, Tool as ToolBase" in plain
...
def test_colorprobe_categorises_git_and_unprobed():
    from livery.toolroom._machinery import _colorprobe, _drivers
    from livery.toolroom._machinery._toolspec import ToolSpec
...
def test_colorprobe_write_leaves_alone_what_it_could_not_probe():
    ...
    """
    from livery.toolroom._machinery import _colorprobe
...
def test_audit_reports_a_runtime_table_that_disagrees(stubs, monkeypatch):
    from livery import toolroom as bridge
    from livery.toolroom._machinery import _tasks as tools_tasks
...
def test_a_verb_that_answers_with_the_root_help_is_not_that_verb(monkeypatch):
    ...
    """
    from livery.toolroom._machinery import _toolhelp
...
def test_a_tool_with_plugins_is_read_under_the_home_they_were_fetched_into(
    ...
    """
    from livery.toolroom._machinery import _tasks as task_module
...
def test_pages_writes_one_per_tool_plus_an_index(tmp_path):
    ...
    for driver in _drivers.DRIVERS:
        ...
        assert f"::: livery.toolroom._stubs.{driver.key}." in body
...
def test_version_tuple_reads_the_leading_integers_and_stops():
    ...
    """
    from livery.toolroom import version_tuple
...
def test_the_prefix_launcher_counts_not_where_it_points(tmp_path):
    ...
    """
    from livery.toolroom._machinery._tasks import _from_prefix
...
def test_a_nested_class_flags_returns_self():
    ...
    source = (
        ...
        / "src/livery/toolroom/_stubs/docker.pyi"
    ).read_text()
